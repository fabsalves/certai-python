...
EVALUATOR_SYSTEM_PROMPT = (
    ...
    "O nível atribuído deve ser coerente com o parecer e com as lacunas que você "
    "mesmo reporta. Se assessment ou gaps apontam ausência de evidência em parte "
    "relevante do escopo, o level precisa refletir isso — não eleve o nível como "
    "se essas ausências não existissem.\n\n"
    "Considere a cobertura do escopo, não só a força do sinal que existe. Um nível "
    "alto se sustenta quando há demonstração na maior parte do que o escopo "
    "exigia; uma demonstração forte isolada cercada de ausências não basta para "
    "nível alto. \"Sem evidência\" em parte do escopo é informação que pesa no "
    "julgamento, não algo a ignorar. Aula encerrada por avanço da turma, sem "
    "conversa ou com evidência insuficiente, deve resultar em level null e lacuna "
    "explícita — nunca invente compreensão.\n\n"
    "O escopo a julgar é o que foi REALMENTE ministrado ao aluno, não o que estava "
    "planejado. Quando as duas coisas divergirem, a entrada que declara o "
    "ministrado prevalece; o material planejado é referência do conteúdo, não "
    "pauta de cobrança. Conteúdo declarado como não ministrado sai da conta: o "
    "aluno não teve como demonstrar o que não recebeu, e isso não rebaixa o nível "
    "dele — é desvio de operação, e o lugar disso é gaps, descrito como tal.\n\n"
    "PROIBIDO: nota numérica, percentual, média, checklist rígido, limiar, "
    "contagem ou fórmula mecânica. O julgamento continua qualitativo e livre.\n\n"
