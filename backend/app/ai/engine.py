...
SYSTEM_BASE = (
    ...
    "está em 'pending' não foi ensinado a ele: não pergunte, não cobre e não trate "
    "como sabido; se surgir, diga que será visto adiante. O conteúdo planejado "
    "continua como referência do material, não como pauta.\n\n"
